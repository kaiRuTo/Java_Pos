 ...
 */
@Component
public class TimNhaCungCapDialog extends javax.swing.JFrame {
    ...
    @Autowired
    public TimNhaCungCapDialog(  SupplierService supplierService) {
        initComponents();
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        _supplier = _supplierService.save(supplier);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        int indexFound = -1;
        for (int j = 0 ; j < _listSupplier.size();j++){
            if (_listSupplier.get(j).getPhone().equals(phone)){
                indexFound = j;
                break;
            }
        }
        ...
        if (indexFound >=0){
            _supplier = _listSupplier.get(indexFound);
            this.dispose();
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TimNhaCungCapDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TimNhaCungCapDialog().setVisible(true);
            }
        });
    }
    ...
    private void loadTable(){
        ...
        for(Supplier c: _listSupplier) {
            ...
            if (name.equals("") && phone.equals("")) {
                ...
                if (c.getName().indexOf(name) != -1 && c.getPhone().indexOf(phone) != -1) {
                    vector.add(c.getName());
                    vector.add(c.getPhone());
                } else {
                    continue;
